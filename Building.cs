...
namespace IDFObjects
{
    ...
    public class Building
    {
        ...
        public void UpdateBuildingConstructionWWROperations(BuildingConstruction construction, WWR wWR, BuildingOperation bOperation)
            ...
            {
                foreach (BuildingSurface toupdate in bSurfaces.Where(s => s.surfaceType == SurfaceType.Wall && s.OutsideCondition == "Outdoors"))
                {
                    toupdate.CreateWindowsShadingControlShadingOverhang();
                }
